...
writeFileSync(input, JSON.stringify({
  ...
  experience: [{
    ...
    location: 'Berlin',
    dates: '2023 - Present',
    bullets: ['Cut deploy time from 40 minutes to 4.', 'Documented deployment checks for repeatable releases.', 'Improved release visibility for engineering stakeholders.'],
  }],
  projects: [{ name: 'Open Source Thing', description: 'A tool people use.', bullets: ['Built a reusable workflow for common engineering tasks.', 'Added validation checks and concise documentation.', 'Kept project behavior easy to inspect and maintain.'] }],
