...
const FILLER = Array(500).fill('analysis').join(' ');
...
const PAYLOAD = {
  ...
  experience: [{ company: 'Corp', role: 'Engineer', dates: 2024, bullets: [`Did a thing ${FILLER}`, 'Documented the workflow.', 'Improved repeatability.'] }],
