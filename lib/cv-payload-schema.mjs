...
export const ENTRY_FIELD_SPECS = {
  ...
  md: {
    ...
    certifications: {
      required: ['title'],
      known: ['title', 'org', 'year', 'url', 'focus'],
    },
    skills: { required: ['items'], known: ['category', 'items'], rules: { items: hasRenderableItems } },
  },
};
...
export const KNOWN_ROOT_KEYS = {
  html: [
    ...
    'interests', 'skills', 'tailoring',
  ],
  tex: [
    'name', 'contact_line', 'email', 'linkedin', 'github',
    'education', 'experience', 'projects', 'awards', 'skills', 'tailoring',
  ],
  md: [
    'name', 'contact_line', 'email', 'phone', 'location', 'linkedin', 'github',
    'summary', 'education', 'experience', 'projects', 'certifications', 'skills', 'tailoring',
  ],
};
...
export const UNRENDERED_SECTIONS = {
  ...
  md: ['competencies', 'awards', 'interests'],
};
